						...
						<form action="update_profile" method="post">
							...
							<div class="form-group">
								<label>Enter Full Name</label><input type="text"
									...
									aria-describedy="emailhelp" name="name" value="${userobj.name }">
							</div>

							<div class="form-group">
								<label>Enter Qualifiaction</label><input type="text"
									required="required" class="form-control" id="exampleInputEmail1"
									aria-describedy="emailhelp" name="qua" value="${userobj.qualification }">
							</div>

							<div class="form-group">
								<label>Enter Email</label><input type="text"
									required="required" class="form-control" id="exampleInputEmail1"
									aria-describedy="emailhelp" name="email" value="${userobj.email }">
							</div>
